                    ...
                    <div class="card login-signup-form-div">
                        ...
                        <form class="login-signup-form signup-form">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm signup-username" placeholder="Email">
                            </div>
                            ...
                            <button class="btn bg-custom" type="submit" name="action">Create Account</button>
