        ...
        <div class="container-fluid main-div">
            <div class="row">
                ...
                <div class="col-md-2 side-div">
                    ...
                    <?php if($_SESSION['username'] == 'commercial@mcc.comXX'): ?>
                    <?php else: ?>
                    ...
                    <hr>
                    <?php if($_SESSION['username'] === 'commercial@mcc.com'): ?>
                        <li><a href="register.php"><span class="lnr lnr-user"></span> Add User</a></li>
                    <?php endif ?>
