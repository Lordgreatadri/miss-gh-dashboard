<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        $query = "SELECT * FROM transactions_completed WHERE response_code = '0000' OR (response_code = '00' AND payment_network = 'VISA') ORDER BY transaction_date DESC LIMIT 800";
