<?php
    ...
    {
        $getContestants =  "SELECT is_votes_display FROM contestants LIMIT 1";
        ...
        {
            $new_status = 'False';
            $update_query = "UPDATE `contestants` SET `is_votes_display` = '$new_status' WHERE `contestant_id` > 0";
            $update_query2 = "UPDATE `contestants_weekly` SET `is_votes_display` = '$new_status' WHERE `contestant_id` > 0";
