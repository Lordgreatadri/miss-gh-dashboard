...
if(isset($_GET['nominee'])) 
{
    ...
    $sql = "SELECT category, contestant_name, `momo_number`, `device`, `vote_count`, `amount`, `tansactions_date` FROM momo_completed_transactions WHERE category = '$ussd_user' AND device = '$channel_type' ORDER BY `tansactions_date` ASC LIMIT 1000";//s.date_unsub = '$today_date'
