<?php
  ...
  include_once "db-config.php";
    ...
    $sql = "SELECT  contestant_name AS NAME, status AS STATUS,  vote_count AS VOTES, updated_at AS 'LAST VOTED' FROM contestants WHERE status = 'Active' ORDER BY vote_count DESC";
