            ...
            <div class="row">
                ...
                <div class="container-fluid content-div">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <h5 class="text-center"><b>Contestants details and their perfomance</b>
                            <a 
                            title="This shows or hides votes on the nominee's voting page."
                            onclick="confirm('Are you sure you want to do this?'); return;"
                            href="controllers/toggle-contentant-vote.php" 
                             class="btn btn-danger btn-sm pull-right" 
                            style="width:120px; border:2px solid green; border-radious:5%;"><b><span class="show-votes"></span></b><i class="fas fa-info-circle fa-solid-900"></i></a>

                            <a 
                            title="This disable or enable votes on the nominee's voting page and the USSD flow."
                            onclick="confirm('Are you sure you want to do this?'); return;"
                            href="controllers/toggle-contentant-enablevote.php" 
                             class="btn btn-danger btn-sm pull-right" 
                            style="width:120px; border:2px solid green; border-radious:5%;"><b><span class="enable-votes"></span></b><i class="fas fa-info-circle fa-solid-900"></i></a>
                        ...
                        <div class="col-md-6">
                            <table class="table table-sm">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><b>Profile</b></td>
                                        <td><span class="contestant-profile">Contestant</span></td>
                                    </tr>
                                    <tr>
